...
export default async function TranscriptArchivePage({ embedded }: { embedded?: boolean } = {}) {
  ...
  return (
    <main className="relative min-h-screen bg-[#05070b] text-white overflow-x-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-6 lg:px-10">
        <Navbar breadcrumbs={[{ label: "Home", href: "/" }, { label: "Transcript Archive" }]} embedded={embedded} />
